...
const SidebarMenuItem: React.FC<{ icon: JSX.Element; children: React.ReactText }> = ({ icon, children }) => (
    <a className="flex cursor-pointer items-center">
        <div className="mr-3 h-5 w-5 text-neutral-500">{icon}</div>
                    ...
                    <article className="w-full">
                        ...
                        <div className="w-full">
                            ...
                            <nav className="flex h-full w-full flex-row justify-evenly font-medium lg:flex-col lg:space-x-0 lg:space-y-5">
                                <SidebarMenuItem icon={<HomeIcon />}>Dashboard</SidebarMenuItem>
                                <SidebarMenuItem icon={<ViewBoardsIcon />}>Projects</SidebarMenuItem>
                                <SidebarMenuItem icon={<InboxIcon />}>Outbox</SidebarMenuItem>
                                <SidebarMenuItem icon={<AdjustmentsIcon />}>Settings</SidebarMenuItem>
                            </nav>
                        </div>
                    </article>
