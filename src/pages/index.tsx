    ...
    return (
        <div className="grid h-full grid-rows-sandwich divide-y divide-neutral-200 bg-white">
            ...
            <main className="grid place-items-center text-neutral-800 heropattern-squares-neutral-100">
                <div className="mx-2 flex w-full flex-col justify-center rounded-sm border border-neutral-200 bg-white py-8 px-6 md:container md:mx-auto md:w-auto md:flex-row md:py-16">
                    ...
                    <div className="mt-4 place-self-center md:pt-0 md:pl-8">
